<script setup>
    ...
    function add(){
        ...
        listsData.value.push(formInput.value)
        generateId+=1
        formInput.value = {
            id:null,
            item:'',
    ...
    function removeItem(id){
        console.log(id)
        listsData.value = listsData.value.filter(item=>item.id!==id)
    }
    function markCompleted(id){
        console.log(listsData.value)
        listsData.value.forEach(item=>
            {
                if (item.id===id){
    ...
    <div class="container">
        ...
        <main>  
            <div class="main-content">
                <ul class="task-items">
                    <li class="task-item" v-for="item in listsData">
